...
while True:
    ...
    if k%256 == 27:
        ...
        Emotions = resp['FaceDetails'][0]['Emotions'][0]['Type']
        Confidence = resp['FaceDetails'][0]['Emotions'][0]['Confidence']


        cv2.putText(frame, 'Emotions : ' + '{0} - {1}'.format(Emotions, Confidence), (10, 60), font, fontSize, fontColor, 2)
